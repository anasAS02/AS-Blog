    ...
    return(
        <div className='w-full h-full p-6 max-md:p-0 relative mt-32'>
            ...
            className='w-full h-full rounded-xl mix-blend-hard-light'
                ...
                alt="Cover"
             />
            <h2 className='text-white text-4xl max-md:text-sm max-md:left-8 max-md:top-2/4 max-md:mt-4 max-lg:mt-0 font-bold absolute top-3/4 left-20 mt-14'>AS Blog | Create your posts now!</h2>
